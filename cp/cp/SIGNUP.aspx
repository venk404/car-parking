...
<body>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Online Car Parkng SystemConnectionString3 %>" SelectCommand="SELECT [username], [password], [email], [contactno], [usertype] FROM [register]"></asp:SqlDataSource>
</body>
</html>
